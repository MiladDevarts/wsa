...
function TitleSection({title, link}) {
    return (
        <div className="container flex justify-between items-center my-4">
            <h3 className="flex items-center gap-x-2 text-white font-bold text-2xl">
                <svg width="27" viewBox="0 0 31 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href={link} className="text-white flex gap-x-2">
                All
