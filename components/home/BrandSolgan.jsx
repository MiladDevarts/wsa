...
function BrandSolgan() {
    return (
        <section className="flex flex-col items-center py-72 lg:py-48 bg-no-repeat bg-center bg-contain mb-32" style={{ backgroundImage: `url('/images/brand/solgan-bg.png')` }}>
