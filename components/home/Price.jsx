...
function Price() {
    ...
    return (
       <>
        <section className="hidden lg:flex flex-col justify-center items-center w-full py-64 lg:my-28  bg-no-repeat bg-center bg-cover" style={{ backgroundImage: `url('/images/brand/price-bg.jpg')` }}>
