    ...
    <>
      ...
      <section className='container flex flex-col gap-y-4 items-center mt-28 text-white'>
        ...
        <h1 className='font-bold text-3xl'>
          Company Communication & Scheduling Platform
        </h1>
      ...
      <section className="w-full h-[700px] my-10 bg-white bg-cover bg-center bg-top-[20px]" style={{ backgroundImage: `url('/images/blog/post-4-cover.webp')` }}></section>
